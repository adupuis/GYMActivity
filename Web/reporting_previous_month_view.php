...
<script type="text/javascript">
	...
	function drawChart() {
		...
		// Set chart options
		var options = {'title':'Reporting mensuel - charge/profil - <?php echo "$year-$d_month_previous" ?> ',
				'is3D': true,
				'width':500,
				'height':300};
		...
		// Set chart options
		var options = {'title':'Reporting mensuel - charge/projet - <?php echo "$year-$d_month_previous" ?> ',
				'is3D': true,
				'width':800,
				'height':300};
