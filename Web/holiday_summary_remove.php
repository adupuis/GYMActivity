...
$header_title = '%COMPANY_NAME% - Suppression solde de congés';
...
<div id="mainarea">
	...
	<p class="mainarea_content">
		...
		<form id="select_login_form" action="holiday_summary_remove.php" method="post">
			...
			<p>
				<input type="submit" value="Supprimer" /> ou <a href="holiday_summary_list.php">annuler</a>
			</p>
		</form>
	</p>
</div>
