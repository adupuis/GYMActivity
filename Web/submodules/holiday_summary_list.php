...
foreach( $geny_holiday_summary->getAllHolidaySummaries() as $tmp ) {
	...
	if( $web_config->theme == "genymobile-2012" ) {
		...
		$remove = "<a href=\"loader.php?module=holiday_summary_remove&holiday_summary_id=$tmp->id\" title=\"Supprimer définitivement le solde de congés\"><img src=\"images/$web_config->theme/holiday_summary_remove_small.png\" alt=\"Supprimer définitiement le solde de congés\"></a>";
	}
	else {
