...
<div id="mainarea">
	...
	<p class="mainarea_content">
		...
		<form id="formID" action="loader.php?module=conges_validation" method="post" class="table_container">
			<style>
...
<?php
	$bottomdock_items = array('backend/widgets/conges_add.dock.widget.php','backend/widgets/conges_list.dock.widget.php');
?>
