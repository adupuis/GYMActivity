...
<div id="mainarea">
	...
	<p class="mainarea_content">
		...
		<form id="formID" action="loader.php?module=conges_deletion" method="post" class="table_container">
			...
			<p>
				<input type="submit" value="Appliquer" /> ou <a href="loader.php?module=conges_list">annuler</a>
			</p>
		</form>
	</p>
</div>
...
<?php
	$bottomdock_items = array('backend/widgets/conges_add.dock.widget.php','backend/widgets/conges_list.dock.widget.php','backend/widgets/conges_validation.dock.widget.php');
?>
