...
foreach( $geny_idea->getAllIdeas() as $tmp ) {
	...
	$view = "<a href=\"loader.php?module=idea_view&load_idea=true&idea_id=$tmp->id\" title=\"Voir l'idée\"><img src=\"images/$web_config->theme/idea_view_small.png\" alt=\"Voir l'idée\"></a>";

	if( $tmp->submitter == $profile->id ||
	    $profile->rights_group_id == 1  || /* admin */
	    $profile->rights_group_id == 2     /* superuser */ ) {
		$edit = "<a href=\"loader.php?module=idea_edit&load_idea=true&idea_id=$tmp->id\" title=\"Editer l'idée\"><img src=\"images/$web_config->theme/idea_edit_small.png\" alt=\"Editer l'idée\"></a>";
	} else {
...
<?php
	$bottomdock_items = array('backend/widgets/notifications.dock.widget.php','backend/widgets/idea_add.dock.widget.php');
?>
